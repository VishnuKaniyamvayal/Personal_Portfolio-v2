...
function Projects() {
  return (
    <div className='bg-gradient-to-b from-[#0f1e26] to-[#000300]'>
        ...
        <div className='bg-transparent grid md:grid-cols-2 lg:grid-cols-3'>
            <div className=' bg-transparent p-10 border rounded-xl m-6 mt-10 border-gray-700 hover:scale-105 duration-300 shadow-lg'>
            ...
            <div className=' bg-transparent p-10 border rounded-xl m-6 mt-10 border-gray-700 hover:scale-105 duration-300 shadow-lg'>
                ...
                <button className='bg-transparent text-[#4ad2b2] text-center mx-auto justify-center mt-4 m  focus:border-green-300 hover:text-green-200'>Go to code</button>
            </div>
        </div>
    </div>
  )
