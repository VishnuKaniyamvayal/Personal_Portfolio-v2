    ...
    <div className='bg-gradient-to-b from-[#000300] to-[#0f1e26] ' id='about'>
        <div className=' bg-transparent pt-16 grid md:grid-cols-2 pb-16 '>
            ...
            <div className='bg-transparent blur-none'>
                ...
                <button onClick={()=>{window.open("https://drive.google.com/u/0/uc?id=1JHvqrqcJ714GOYw1024qf82owjzATUeP&export=download")}} className='text-white flex justify-center mx-auto  bg-gradient-to-br from-[#40d9bd] to-[#4ad29a] rounded-xl w-[200px] h-[50px] p-3 '>Download CV</button>
            </div>       
        </div>
